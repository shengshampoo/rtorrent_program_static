...
RUN apk add --no-cache \
  ...
  c-ares-dev nghttp2-static nghttp2-dev libpsl-static \
  libpsl-dev xz-static xz-dev zstd-dev zstd-static \
  libssh2-dev libssh2-static libunistring-static libunistring-dev \
  cmake ninja bash xz libtool autoconf automake
